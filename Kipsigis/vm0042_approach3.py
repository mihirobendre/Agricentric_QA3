...
if __name__ == "__main__":
    ...
    bl_synth = calc_fertilizer(
        fertilizer_type       = "npk_blend",          # DAP 18-46-0
        application_rate_t_ha = 0.15,          # t DAP ha⁻¹ yr⁻¹
        climate               = CLIMATE,
        apply_leaching        = APPLY_LEACHING,
    )
    ...
    wps_synth = calc_fertilizer(
        fertilizer_type       = "npk_blend",  # CAN 27-0-0
        application_rate_t_ha = 0.075,          # t CAN ha⁻¹ yr⁻¹
        climate               = CLIMATE,
        apply_leaching        = APPLY_LEACHING,
    )
