...
urea_mass_t = 50 * tons_per_kilo * project_area_ha  # 
npk_mass_t = 50 * tons_per_kilo * project_area_ha # 
dap_mass_t = 50 * tons_per_kilo  * project_area_ha #
can_mass_t = 50 * tons_per_kilo  * project_area_ha #
...
N_dap_t = dap_mass_t * dap_n_content
N_can_t = can_mass_t * can_n_content 

FSNbsl_it = N_urea_t + N_npk_t + N_dap_t + N_can_t # Total synthetic N applied
