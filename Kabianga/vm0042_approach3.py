...
if __name__ == "__main__":
    ...
    bl_synth = calc_fertilizer(
        fertilizer_type       = "calcium_ammonium_nitrate",          # DAP 18-46-0
        application_rate_t_ha = 0.1,          # t DAP ha⁻¹ yr⁻¹
        climate               = CLIMATE,
        apply_leaching        = APPLY_LEACHING,
    )
    ...
    bl_manure = calc_fertilizer(
        ...
        application_rate_t_ha = 5,            # t solid manure ha⁻¹ yr⁻¹
        climate               = CLIMATE,
        apply_leaching        = APPLY_LEACHING,
    )
    ...
    wps_synth = calc_fertilizer(
        fertilizer_type       = "calcium_ammonium_nitrate",  # CAN 27-0-0
        application_rate_t_ha = 0.05,          # t CAN ha⁻¹ yr⁻¹
        climate               = CLIMATE,
        apply_leaching        = APPLY_LEACHING,
    )
    ...
    PROJECT = build_scenario(
        label       = "Project",
        burning     = wps_burning,
        fertilizers = [wps_manure, wps_synth, wps_compost, wps_biochar],
    )
